...
include 'conexion.php';
$sql = "select id_usuario,nombre,apellidos,especialidad,popularidad,telefono,foto from monitores";
$result = mysql_query($sql,$conexion);
while(($fila = mysql_fetch_row($result)) != null){
	...
	<tr class="gradeA">
		<?php for($i=0;$i<6;$i++){?>
			...
			<td> <img src=" <?php echo $fila[6]; ?> " width = "60px"/> </td>
			<td> 
				<form method="post" action="eliminarMonitor.php"><input type="hidden" name="idMonitor" value="<?php echo $fila[0]; ?> "><input type="hidden" name="fotoMonitor" value="<?php echo $fila[6]; ?> "><button type="submit" name="delete">Borrar</button></form>
				<form method="post" action="editarMonitor.php"><input type="hidden" name="idMonitor" value="<?php echo $fila[0]; ?> "><button type="submit" name="editar">Editar</button></form>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Listar Monitores</span></li>
							</ol>
					...
					<?php if($_SESSION['rol'] == "admin"){ ?>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Monitores Registrados</h2>
							</header>

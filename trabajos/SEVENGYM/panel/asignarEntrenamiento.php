...
function entrenamientosDisponibles(){
	include 'conexion.php';
	$sql = "select id,nombre from entrenamiento where id_entrenador = ".$_SESSION['id']." ";
	$result = mysql_query($sql,$conexion);
	while(($fila = mysql_fetch_assoc($result))!= NULL){
		?>  <option value="<?php echo $fila['id']; ?>"><?php echo $fila['nombre']; ?></option> <?php
...
if(isset($_POST['continuar'])){
    $idEntrenamiento = $_POST['trainning'];
    $idEj = $_POST['idEjercicio'];
    $idMonitor = $_SESSION['id'];
    include 'conexion.php';
    $sql = "insert into entrenamiento_ejercicio(id_entrenamiento,id_ejercicio,id_monitor) values (".$idEntrenamiento.",".$idEj.",".$idMonitor." )";
					...
					<div id="userbox" class="userbox">
                        ...
                        <div class="dropdown-menu">
                            <ul class="list-unstyled">
                                <li class="divider"></li>
                                <li>
                                    <a role="menuitem" tabindex="-1" href="perfilUsuario.php"><i class="fa fa-user"></i> Mi Perfil</a>
                                </li>
                                <li>
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Seleeccion Entrenamiento</span></li>
							</ol>
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" action="#" method="post"> 
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Entrenamiento a asignar</label>
                                            <div class="col-md-6">
                                                <select  class="form-control populate" name="trainning">

                                                    <optgroup label="Nombre Entrenamiento">
                                                        <?php entrenamientosDisponibles(); ?>
  										...
  										<input type = "hidden" value = "<?php echo $_POST['idEjercicio']; ?>" name = "idEjercicio"> 
                                        

                                        <div class="form-group" align="center">
                                            <button type="submit" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg" value="continuar" name="continuar">Continuar</button>

...
if(isset($_POST['altaEntrenamiento'])){
...
function insertar($datos){
	include 'conexion.php';
		$sql = "insert into entrenamiento (id_entrenador,tipo,nombre,duracion,num_ejercicio,tipo_dieta,observacion,intensidad) values ( ".$_SESSION['id'].",'".$datos['tipoEntrenamiento']."','".$datos['nombreEntrenamiento']."',".$datos['duracion'].",".$datos['numEjercicios'].",'".$datos['tipoDieta']."','".$datos['observaciones']."',".$datos['intensidad'].")";
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" action="#" method="post" enctype = "multipart/form-data"> 
                                        ...
                                        <div class="form-group" align="center">
                                            <button type="submit" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg" value="enviar" name="altaEntrenamiento">Enviar</button>

...
function mostrarCorreos(){
	...
	if($fila[1] == $_SESSION['id']){
	?>

										<div class="panel">
											<div class="panel-heading">								
							
												<p class="panel-title">Asunto:<i class="fa fa-angle-right fa-fw"></i> <?php echo $fila[2]; ?>
													<p><?php echo "Para:".getNick($fila[0]);?></p>
											</div>
											...
											<div class="panel-footer">
												<p class="m-none"><small><?php echo $fila[4]; ?></small></p>
											</div>
...
function getNick($id){
		include 'conexion.php';
		$result = mysql_query("select id,nick from usuarios where id = '".$id."'",$conexion);
									...
									<div class="nano-content">
										...
										<div class="inner-menu-content">
											...
											<ul class="list-unstyled mt-xl pt-md">
												<li>
													<a href="mailBox.php" class="menu-item">Bandeja Entrada <span class="label label-primary text-normal pull-right"><?php echo numCorreos(); ?></span></a>
												</li>
										
												<li>
													<a href="mailbox-enviados.php" class="menu-item active">Enviados</a>
												</li>

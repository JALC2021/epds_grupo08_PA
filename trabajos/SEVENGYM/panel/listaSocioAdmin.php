...
include 'conexion.php';
$sql = "select id_usuario,nombre,apellidos,fecha_nacimiento,sexo,foto_usuario,telefono_movil,telefono_fijo,direccion,descuento from socios";
$result = mysql_query($sql,$conexion);
while(($fila = mysql_fetch_row($result)) != null){
	...
	<tr class="gradeA">
		<?php for($i=0;$i<5;$i++){?>
			...
			<td> <img src=" <?php echo "fotos/".$fila[5]; ?> " width = "100px"/> </td>
			<td> <form method="post" action="perfilUsuario.php">

				<input type="hidden" name="id" value="<?php echo $fila[0]; ?> ">
				<input type="hidden" name="nombre" value="<?php echo $fila[1]; ?> ">
				<input type="hidden" name="apellidos" value="<?php echo $fila[2]; ?> ">
				<input type="hidden" name="fecha_nacimiento" value="<?php echo $fila[3]; ?> ">
				<input type="hidden" name="sexo" value="<?php echo $fila[4]; ?> ">
				<input type="hidden" name="foto_usuario" value="<?php echo $fila[5]; ?> ">
				<input type="hidden" name="telefono_movil" value="<?php echo $fila[6]; ?> ">
				<input type="hidden" name="telefono_fijo" value="<?php echo $fila[7]; ?> ">
				<input type="hidden" name="direccion" value="<?php echo $fila[8]; ?> ">
				<input type="hidden" name="descuento" value="<?php echo $fila[9]; ?> ">

				<button type="submit" name="perfil">Ver Perfil</button>



			</form>
				<form method="post" action="eliminarSocio.php"><input type="hidden" name="idSocio" value="<?php echo $fila[0]; ?> "><input type="hidden" name="fotoUsuario" value="<?php echo $fila[5]; ?> "><button type="submit" name="delete">Borrar</button></form>
					...
					<?php if($_SESSION['rol'] == "admin"){ ?>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Socios Registrados</h2>
							</header>

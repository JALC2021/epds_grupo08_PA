	...
	<tr class="gradeA">
		<?php for($i=0;$i<6;$i++){?>
			...
			<?php }?>		
				...
				<form method="post" action="asignarEntrenador.php"><input type="hidden" name="idMonitor" value="<?php echo $fila[0]; ?> "><button type="submit" name="asignarMonitor">Asignar</button></form>

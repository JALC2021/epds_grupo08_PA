...
if(isset($_POST['actualizarMonitor'])){
	...
	if(!isset($_POST['password']) or $_POST['password'] == ""){
		...
		$datos['password'] = filter_var(filter_input(INPUT_POST, 'password', FILTER_SANITIZE_SPECIAL_CHARS));
	}
...
function actualizarMonitor($datos){
	
	include 'conexion.php';
		$sql = "update monitores set nombre='".$datos['nombreMonitor']."',apellidos='".$datos['apellidos']."',especialidad='".$datos['especialidad']."',popularidad=".$datos['popularidad'].",telefono=".$datos['movil'].",foto='".$datos['foto_monitor']."' where id_usuario = ".$datos['idUser']."";		
		mysql_query($sql,$conexion);
		mysql_close($conexion);
}
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Editar Monitor</span></li>
							</ol>
                            ...
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" action="#" method="post" enctype = "multipart/form-data"> 
                                        ...
                                        <input type="hidden" name="idMonitor" value="<?php echo $_POST['idMonitor']; ?>">                                      

                                        <div class="form-group" align="center">
                                            <button type="submit" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg" value="Actualizar" name="actualizarMonitor">Actualizar</button>

...
if(($_FILES['image1']['error']>0 or !comprobarTipo($_FILES['image1']['type']) or $_FILES['image1']['size']>1024*1024) or ($_FILES['image2']['error']>0 or !comprobarTipo($_FILES['image2']['type']) or $_FILES['image2']['size']>1024*1024)){
	...
	if(isset($fails)){
		...
		$datos['idEjercicio'] = $_POST['idEjercicio'];
		actualizar($datos);
...
function actualizar($datos){
	include 'conexion.php';
		$sql = "update  ejercicio set grupo_muscular ='".$datos['grupoMuscular']."',observacion='".$datos['observaciones']."',repeticiones=".$datos['numRep'].",nombre_ejercicio='".$datos['nombreEjercicio']."',peso=".$datos['peso'].",series=".$datos['numSeries'].",imagen1='".$datos['image1']."',imagen2='".$datos['image2']."',video='".$datos['video1']."' where id= ".$datos['idEjercicio']." ";
					...
					<?php if($_SESSION['rol'] == "monitor" and isset($_POST['editar'])){ ?>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Editar Ejercicio</h2>
							</header>
							<div class="panel-body">
                                    <form class="form-horizontal form-bordered" action="#" method="post" enctype = "multipart/form-data"> 
                                        ...
                                        <div class="form-group" align="center">
                                            <button type="submit" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg" value="enviar" name="actualizarEjercicio">Actualizar</button>
                                            <button type="reset" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg" value="reset" name="reset">Resetear</button>
                                            <input type="hidden" name = "idEjercicio" value = "<?php echo $_POST['idEjercicio']; ?>">

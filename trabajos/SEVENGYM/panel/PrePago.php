...
function sociosDisponibles(){
	...
	$sql = "select id_usuario,nombre,apellidos from socios";
	$result = mysql_query($sql,$conexion);
	while(($fila = mysql_fetch_assoc($result))!= NULL){
		?>  <option value="<?php echo $fila['id_usuario']; ?>"><?php echo $fila['nombre']."-".$fila['apellidos']; ?></option> <?php
               ...
               <aside id="sidebar-left" class="sidebar-left">
				...
				<section role="main" class="content-body">
					...
					<header class="page-header">
						<h2>Selección de Socio a realizar el pago</h2>
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Seleeccion Socio</span></li>
							</ol>
                        ...
                        <div class="col-xs-12">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" action="altaPago.php" method="post"> 
                                        <div class="form-group">
                                            <label class="col-md-3 control-label">Cliente a realizar el pago</label>
                                            <div class="col-md-6">
                                                <select  class="form-control populate" name="socio">

                                                    <optgroup label="Nombre/Apellidos">
                                                        <?php sociosDisponibles(); ?>

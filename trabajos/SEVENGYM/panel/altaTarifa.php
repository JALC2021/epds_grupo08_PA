...
if(isset($_POST['altaTarifa'])){
	...
	if(!isset($_POST['precio']) or $_POST['precio'] == "" or $_POST['precio']<1){
	...
	if(isset($fails)){
		...
		insertarTarifa($datos);
		
		header("Location:listarTarifa.php");
	}

}
function insertarTarifa($datos){
	include 'conexion.php';
		$sql = "insert into tarifa (nombre,descripcion,duracion,precio) values ('".$datos['nombreTarifa']."','".$datos['descripcion']."',".$datos['duracion'].",".$datos['precio'].")";
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal form-bordered" action="#" method="post"> 
                                        ...
                                        <div class="form-group" align="center">
                                            <button type="submit" class="mb-xs mt-xs mr-xs btn btn-warning btn-lg" value="enviar" name="altaTarifa">Enviar</button>

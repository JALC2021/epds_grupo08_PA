...
while(($fila = mysql_fetch_row($result)) != null){
	...
	<tr class="gradeA">
		<?php for($i=0;$i<7;$i++){?>
			...
			<?php }?>
			<td> <img src=" <?php echo $fila[7]; ?> " width = "60px"/> </td>
			<td> <img src="<?php echo $fila[8]; ?>" width = "60px"/> </td>
			<td> <a style = "color:blue;" href = "<?php echo $fila[9]; ?>">Video</a> </td>
			

				<td class="actions">
				<form method="post" action="eliminarEjercicio.php"><input type="hidden" name="idEjercicio" value="<?php echo $fila[0]; ?> "><input type="hidden" name="fotoEjercicio1" value="<?php echo $fila[7]; ?> "><input type="hidden" name="fotoEjercicio2" value="<?php echo $fila[8]; ?> "><button type="submit" name="delete" class="mb-xs mt-xs mr-xs btn btn-sm btn-primary">Borrar</button></form>
				<form method="post" action="editarEjercicio.php"><input type="hidden" name="idEjercicio" value="<?php echo $fila[0]; ?> "><button type="submit" name="editar" class="mb-xs mt-xs mr-xs btn btn-sm btn-primary">Editar</button></form>
                 <form method="post" action="asignarEntrenamiento.php"><input type="hidden" name="idEjercicio" value="<?php echo $fila[0]; ?> "><button type="submit" name="asignar" class="mb-xs mt-xs mr-xs btn btn-sm btn-primary">Asignar</button></form>
					...
					<?php if($_SESSION['rol'] == "monitor"){ ?>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Lista de Ejercicios</h2>
							</header>

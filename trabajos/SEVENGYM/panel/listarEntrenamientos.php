...
include 'conexion.php';
$sql = "select id,tipo,nombre,duracion,num_ejercicio,tipo_dieta,observacion,intensidad from entrenamiento where id_entrenador = '".$_SESSION['id']."' ";
$result = mysql_query($sql,$conexion);
	...
	<tr class="gradeA">
		<?php for($i=0;$i<8;$i++){?>
			...
			<?php }?>		
				...
				<td class="actions">
				<form method="post" action="eliminarEntrenamiento.php"><input type="hidden" name="idEntrenamiento" value="<?php echo $fila[0]; ?> "><button type="submit" name="delete">Borrar</button></form>
				<form method="post" action="editarEntrenamiento.php"><input type="hidden" name="idEntrenamiento" value="<?php echo $fila[0]; ?> "><button type="submit" name="editar">Editar</button></form>
					...
					<?php if($_SESSION['rol'] == "monitor"){ ?>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Mis Entrenamientos</h2><br/>
								<a href = "altaEntrenamiento.php" id="addToTable" class="btn btn-primary">Añadir<i class="fa fa-plus"></i></a>
							</header>

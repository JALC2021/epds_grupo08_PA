...
while(($fila = mysql_fetch_row($result)) != null){
	...
	<tr class="gradeA">
		<?php for($i=0;$i<8;$i++){?>
			...
			<td> 
				<form method="post" action="editarPagoRealizado.php"><input type="hidden" name="idpago" value="<?php echo $fila[0]; ?> "><button type="submit" name="editar">Editar</button></form>
			</td>
				</tr>
	<?php }
	mysql_close($conexion);
					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Pagos Pendiente</span></li>
							</ol>
					...
					<?php if($_SESSION['rol'] == "admin"){ ?>
						...
						<section class="panel">
							<header class="panel-heading">
								...
								<h2 class="panel-title">Pagos pendientes</h2>
							</header>

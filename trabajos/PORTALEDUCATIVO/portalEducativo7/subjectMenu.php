...
<div class="afterMenuSubj">
    <div class="container">
        ...
        <ul id="nav">
            ...
            <li><a href="noticesView.php?subjectId=<?php echo $subjectId; ?>&subjectName=<?php echo $_GET['subjectName'] ?>">Anuncios</a></li>
            <li><a href="docsView.php?subjectId=<?php echo $subjectId; ?>&subjectName=<?php echo $_GET['subjectName'] ?>">Documentos</a></li>

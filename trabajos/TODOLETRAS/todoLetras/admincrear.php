<?php
	...
	//TABLA LIBRO
	$tabla1="libros";
	$sql_creartabla1="CREATE TABLE $tabla1(idlibro INT PRIMARY KEY NOT NULL AUTO_INCREMENT, titulo VARCHAR(100) NOT NULL, autor VARCHAR(50) NOT NULL, editorial VARCHAR(30) NOT NULL, genero VARCHAR(20) NOT NULL, anoedicion INT(4) NOT NULL, isbn VARCHAR(30) NOT NULL, imagen VARCHAR(50) NOT NULL, precio FLOAT NOT NULL,ventas FLOAT NOT NULL,fechahora DATETIME NOT NULL);";
	$sql_insertarlibro1="INSERT INTO $tabla1 VALUES (0,'Crepusculo','Stephenie Meyer','Alfaguara','Novela',2005,'978-884-20-47113','crepusculo.jpg', 14.50,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro2="INSERT INTO $tabla1 VALUES (0,'Luna Nueva','Stephenie Meyer','Alfaguara','Novela',2006,'978-8483-65-1803','lunanueva.jpg', 14.50,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro3="INSERT INTO $tabla1 VALUES (0,'Eclipse','Stephenie Meyer','Alfaguara','Novela',2007,'978-884-20-46928','eclipse.jpg', 14.50,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro4="INSERT INTO $tabla1 VALUES (0,'Amanecer','Stephenie Meyer','Alfaguara','Novela',2008,'978-8420-40-6268','amanecer.jpg', 17.50,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro5="INSERT INTO $tabla1 VALUES (0,'The Host','Stephenie Meyer','Suma','Novela',2010,'978-842-04-72331','thehost.jpg', 20.00,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro6="INSERT INTO $tabla1 VALUES (0,'La segunda vida de Bree Tanner','Stephenie Meyer','Alfaguara','Novela',2010,'978-607-11-00334','breetanner.jpg', 7.90,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro7="INSERT INTO $tabla1 VALUES (0,'Apocalypse','Tim Bowler','Sin limites','Novela',2004,'978-84-9759-2907','apocalypse.jpg', 10.00,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro8="INSERT INTO $tabla1 VALUES (0,'El simbolo perdido','Dan Brown','Booket','Novela',2009,'978-84-9764-4742','simboloperdido.jpg', 19.60,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro9="INSERT INTO $tabla1 VALUES (0,'Los pilares de la Tierra','Ken Follet','Debolsillo','Novela',1989,'978-8437-60-7710','lospilaresdelatierra.jpg', 17.80,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro10="INSERT INTO $tabla1 VALUES (0,'Cumbres Borrascosas','Emily Bronte','Edimat libros','Novela',2009,'978-8437-60-7719','cumbresborrascosas.jpg', 5.00,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro11="INSERT INTO $tabla1 VALUES (0,'Bajarse al moro','Jose Luis Alonso de Santos','Catedra','Novela',2005,'978-84-08-099224','bajarsealmoro.jpg', 7.00,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro12="INSERT INTO $tabla1 VALUES (0,'El curso en que me enamore de ti','Blanca Alvarez','Nautilus','Novela',2004,'84-666-2471-6527','elcurso.jpg', 6.30,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro13="INSERT INTO $tabla1 VALUES (0,'La catedral','Cesar Mallorqui','SM','Novela',2000,'84-348-7239-0452','lacatedral.jpg', 8.50,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro14="INSERT INTO $tabla1 VALUES (0,'A tres metros sobre el cielo','Federico Moccia','Booket','Novela',2012,'9788408110491','atresmetros.jpg', 6.99,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro15="INSERT INTO $tabla1 VALUES (0,'Tengo ganas de ti','Federico Moccia','Planeta','Novela',2012,'9788408095545','tengoganasdeti.jpg', 9.95,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro16="INSERT INTO $tabla1 VALUES (0,'Flor del desierto','Waris Dirie','RBA','Novela',2003,'9788492695980','flordesierto.jpg', 8.20,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro17="INSERT INTO $tabla1 VALUES (0,'Un burka por amor','Reyes Monforte','Temas de hoy','Novela',2007,'9788484606499','unburkaporamor.jpg', 5.20,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro18="INSERT INTO $tabla1 VALUES (0,'Perdona si te llamo amor','Federico Moccia','Planeta','Novela',2009,'9788408101741','perdonasitellamo.jpg', 9.95,0,'2015-01-01 12:30:12');";
	$sql_insertarlibro19="INSERT INTO $tabla1 VALUES (0,'Perdona pero quiero casarme contigo','Federico Moccia','Planeta','Novela',2011,'9788408101758','perdonaperoquiero.jpg', 9.95,0,'2015-01-01 12:30:12');";
        $sql_insertarlibro20="INSERT INTO $tabla1 VALUES (0,'Un Jardín al Norte','Boris Izaguirre','Planeta','Novela',2015,'9788408101759','jardin.jpg', 19.95,0,'2015-01-16 12:30:12');";
	
	//TABLA USUARIO
	$tabla2="usuarios";
	$sql_creartabla2="CREATE TABLE $tabla2(usuario VARCHAR(10) PRIMARY KEY NOT NULL, contrasena VARCHAR(600) NOT NULL, nombre VARCHAR(30) NOT NULL, apellidos VARCHAR(70), sexo VARCHAR(6) NOT NULL, edad VARCHAR(10) NOT NULL, dni VARCHAR(10) NOT NULL, tipo VARCHAR(15) NOT NULL);";
	...
	if(!$resultado){
        ...
        $resultado=mysql_query($sql_insertarlibro20,$conexion);
	if(!$resultado){
		echo "No se han podido insertar regsitros en la tabla $tabla1<br>";
	}
	else{

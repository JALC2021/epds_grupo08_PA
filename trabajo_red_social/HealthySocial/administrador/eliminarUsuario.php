                            ...
                            <form method="POST">
                                <table>
                                    ...
                                    while ($usuarios = mysqli_fetch_array($rowUsuario)) {
                                        ?>
                                        <tr><td><input type="radio" name="id_usuario_eliminar" value="<?PHP echo $usuarios['id_usuario'] ?>" /></td><td><?PHP echo $usuarios['usuario'] ?></td><td><?PHP echo $usuarios['nombre'] ?></td><td><?PHP echo $usuarios['apellidos'] ?></td><td><?PHP echo $usuarios['email'] ?></td><td><?PHP echo $usuarios['localidad'] ?></td></tr>
                                        <?PHP
                                    }
                                    ?>
                                </table>
